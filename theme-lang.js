(function () {
  ...
  const messages = {
    ...
    en: {
      ...
      'hobbies.volleyball.AS': "Passionate about sports, I have been involved in the AS since middle school through high school, and am now part of the AS INP women's team, as well as the mixed team competing in the Coupe de France.",
      'hobbies.piano.title': 'Piano',
