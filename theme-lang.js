(function () {
  ...
  const messages = {
    fr: {
      ...
      'exp.stage3.description': "Lors de cette première immersion dans le monde professionnel, j’ai découvert les différents métiers et l’environnement de travail au sein d’une entreprise technologique. J’ai pu observer plusieurs domaines d’activité tels que l’ingénierie, le <strong>contrôle qualité</strong>, les <strong>méthodes</strong>, la <strong>production</strong> et la <strong>logistique</strong>. J’ai également été initiée à divers outils professionnels, notamment le logiciel SAP, la conception assistée par ordinateur (Pro-Engineer). <br> Cette expérience m’a aidé à développer des qualités essentielles en milieu professionnel comme <strong>l’écoute, la rigueur, la curiosité et la capacité d’adaptation.</strong>",
	  'ingenierie.item1.title' : 'Projet scientifique – Transition énergétique (TIPE)',
	  'ingenierie.item1.description' : "Dans le cadre de mon TIPE, projet axé sur les <strong>énergies renouvelables</strong> et la <strong>transition écologique</strong>, j’ai étudié l’influence néfaste de la température sur les performances des panneaux photovoltaïques et recherché des solutions pour <strong>améliorer leur rendement et réduire les pertes énergétiques</strong>. <br> Après une analyse théorique du comportement des cellules solaires face à la chaleur, j’ai mené des <strong>mesures expérimentales</strong> afin de quantifier ces effets et de tester plusieurs méthodes de refroidissement, actives et passives. J’ai ensuite <strong>interprété, comparé et validé</strong> mes résultats expérimentaux par rapport aux modèles théoriques, ce qui m’a permis de mieux comprendre les compromis entre performance énergétique, contraintes environnementales et faisabilité technique.",
      ...
      'hobbies.volleyball.description': "J'ai joué au volley-ball en club pendant <strong>12 ans</strong> :",
      ...
      'hobbies.volleyball.level': "J’ai finalement atteint un niveau <strong>National 3</strong> et je fait maintenant partie de l'équipe 1 de l'<strong>AS INP</strong>.",
      'hobbies.piano.title': 'Piano',
      'hobbies.piano.description': "J'ai joué du piano pendant <strong>5ans</strong> ainsi qu'un peu de solvège. J'ai notamment participer à des représentations.",
      'hobbies.hiking.title': 'Randonnée',
      'hobbies.hiking.description1': 'Passion pour la <strong>montagne</strong> et la découverte de nouveaux paysages, notamment les sentiers des Alpes.',
	  'hobbies.hiking.description2': 'Projet <strong>GR20</strong> en Corse',
    ...
    en: {
      ...
      'hobbies.volleyball.description': 'I have played volleyball in clubs for <strong>12 years</strong>:',
	  ...
	  'hobbies.hiking.description1': 'Passion for the <strong>mountains</strong> and discovering new landscapes, especially the trails of the Alps.',
	  'hobbies.hiking.description2': 'GR20 project in Corsica',
      'elevator.title': 'Elevator Speech',
